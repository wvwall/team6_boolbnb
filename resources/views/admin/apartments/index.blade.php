  ...
  <div class="container">
    <div id="apa" class=" row justify-content-center">
      <div class="col-md-12" style="text-align: center;">
        <h3 class="mt-20 mb-20">I TUOI APPARTAMENTI</h3>
      </div>
      <div class="center">
        <a class=" btn btn-primary" style="margin: 20px 0;" href="{{route('admin.apartments.create')}}"><i class="fas fa-plus"></i> Appartamento</a>
        <a class=" btn btn-second" style="margin: 20px 0;" href="{{route('admin.promotions.index')}}"><i class="fas fa-ad"></i> Sponsorizza</a>
      </div>
