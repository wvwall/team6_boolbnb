...
var app1 = new Vue({
  ...
  methods: {
    dati: function dati() {
      ...
      axios.get("https://api.tomtom.com/search/2/structuredGeocode.json?countryCode=IT&streetName=".concat(this.indirizzo, "&municipality=").concat(this.citta, "&key=").concat(this.key)).then(function (response) {
